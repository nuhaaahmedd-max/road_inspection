    ...
    if not df_plot.empty:
        ...
        if view == "Points":
            for r in df_plot.itertuples():
                ...
                folium.CircleMarker(location=[r.Longitude, r.Latitude], radius=6, color=p_color, fill=True, fill_opacity=0.8).add_to(m)
        else:
...
with col3:
    ...
    if map_data and map_data.get("last_object_clicked"):
        ...
        # البحث في البيانات (بناءً على الترتيب في الـ CSV الخاص بك)
